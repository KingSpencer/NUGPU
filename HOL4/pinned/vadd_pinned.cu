...
int main( int argc, char* argv[] ) { 
	...
	Data data_cpu;
    // HERE
	cudaMallocHost ( &data_cpu.a, vector_size*sizeof(double)); 
	cudaMallocHost ( &data_cpu.b, vector_size*sizeof(double)); 
	cudaMallocHost ( &data_cpu.c, vector_size*sizeof(double)); 
	Data data_gpu_on_cpu;
	cudaMallocHost ( &data_gpu_on_cpu.c, vector_size*sizeof(double));
