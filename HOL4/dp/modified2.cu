...
__global__ void third_calculation(    char* dev_a, 
                                char* dev_b, 
                                char* dev_c,
                                int num_matrices,                                                
                                int matrix_size,
...
__global__ void second_calculation(    char* dev_a, 
    ...
    third_calculation<<<grid_size, block_size>>>(dev_a, dev_b, dev_c, num_matrices, matrix_size, k, j);
}
...
__global__ void calculation(    char* dev_a, 
    ...
    if (dev_a[k*matrix_size*matrix_size] != 0){
        int grid_size = (matrix_size - 1) / block_size + 1;
        second_calculation<<<grid_size, block_size>>>(dev_a, dev_b, dev_c, num_matrices, matrix_size, k);
    }
}
/*
__global__ void calculation(    char* dev_a, 
